...
export default function ManageChildren() {
  ...
  const handleDelete = async (childId) => {
    if (window.confirm('Are you sure? This will delete the kid and all their wishlist items.')) {
      try {
  ...
  return (
    <div className="page-content">
      <div style={{ marginBottom: '30px' }}>
        <h2>Manage Kids</h2>
        <p>
          Add your kids and set up their login credentials. They'll use their name and PIN to access their wishlist.
        </p>
        <button
          onClick={() => {
            setEditingChild(null);
            ...
            <div key={child.id} className="card">
              ...
              {child.target_budget && (
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div style={{ fontSize: '20px', color: '#165B33', marginTop: '4px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-group">
                ...
                <small style={{ color: '#718096', marginTop: '4px', display: 'block' }}>
                  Your kid will login at /{formData.route || 'route'} (lowercase letters, numbers, hyphens only)
                </small>
              </div>
